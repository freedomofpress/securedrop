...
The [wordlist](/securedrop/dictionaries/diceware.txt) we use to generate source passphrases is based off a new [Diceware wordlist](https://www.eff.org/deeplinks/2016/07/new-wordlists-random-passphrases) from the EFF.
