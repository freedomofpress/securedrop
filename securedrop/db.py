...
class Source(Base):
    ...
    def to_json(self):
        ...
        json_source = {
            ...
            'submissions_url': url_for('api.all_source_submissions', source_id=self.id),
...
class Submission(Base):
    ...
    def to_json(self):
        json_submission = {
            'source_url': url_for('api.single_source', source_id=self.source_id),
            'submission_url': url_for('api.single_submission', source_id=self.source_id,
                                      submission_id=self.id),
            'submission_id': self.id,
            'filename': self.filename,
            'size': self.size,
            'is_read': self.downloaded,
            'download_url': url_for('api.download_submission', source_id=self.source_id,
                                     submission_id=self.id),
        }
