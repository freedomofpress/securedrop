...
class SourceInterfaceFlaskConfig(FlaskConfig):
    SECRET_KEY = 'RVVzhdwJCh0aRpKu5XiKpjWHcOWvIm7ntxSzXoU5uWA='

class JournalistInterfaceFlaskConfig(FlaskConfig):
    SECRET_KEY = 'IplVQ9FeWKc28rYccoRhSchthOLM8oCdaeqSgrsIEkQ='
...
SCRYPT_ID_PEPPER = '4TpWpD3qvJvaYq5LgjuoAGfWio6o69pfOWKiue1ZVu8='
# "head -c 32 /dev/urandom | base64" for stretching source codename into GPG passphrase
SCRYPT_GPG_PEPPER = 'bBizEs8qjZrLIsgOv/Ql9TjLmQnZykMU4kQfsNjSFN4='
