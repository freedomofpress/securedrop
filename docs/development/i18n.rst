...
.. code:: sh
      ...
      $ git checkout lab/i18n -- securedrop/translations \
        install_files/ansible-base/roles/tails-config/templates/{nl,fr,de_DE,nb_NO,pt_BR,es_ES,zh_Hant}.po
      $ git add securedrop/translations/{nl,fr,de_DE,nb_NO,pt_BR,es_ES}/LC_MESSAGES/messages.po \
        install_files/ansible-base/roles/tails-config/templates/{nl,fr,de_DE,nb_NO,pt_BR,es_ES,zh_Hant}.po
...
.. code:: sh
      ...
      $ for l in nl fr de_DE nb_NO pt_BR es_ES zh_Hant ; do echo -n "$l " ; git log --format=%aN lab/i18n -- install_files/ansible-base/roles/tails-config/templates/$l.po securedrop/translations/$l/LC_MESSAGES/messages.po | sort -u | tr '\n' ',' | sed -e 's/,/, /g' ; echo ; done
      nl Anne M, kwadronaut, Loic Dachary, Yarno Ritzen,
      fr Alain-Olivier,
      de_DE Anna Skaja, Eric H., Ettore Atalan, kwadronaut, Loic Dachary,
      nb_NO Allan Nordhøy, A. Nonymous, Loic Dachary, Øyvind Bye Skille,
      pt_BR Bernardo Tonasse, Cecília do Lago, communiaa, Loic Dachary,
      es_ES Anatoli, A. Nonymous, Camille Fassett, Daniel Arauz, Freddy Martinez, Jose, Loic Dachary,
      zh_Hant A. Nonymous, Chi-Hsun Tsai, H.-L. Lee, Jin Lin Wright, Loic Dachary, Shih-Chieh Ilya Li,
...
.. code:: sh
      ...
      $ PAGE_LAYOUT_LOCALES='de_DE,es_ES,fr_FR,nb_NO,nl,pt_BR,zh_Hant' \
          pytest -v --page-layout tests/pages-layout
