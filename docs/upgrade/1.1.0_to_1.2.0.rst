...
.. important:: If you do see the warning "refname '1.2.0' is ambiguous" in the
...
-----------------------------
SecureDrop 1.2.0 includes a kernel update on the *Application* and *Monitor
Servers* from the 4.4 to the 4.14 series. As with all kernel updates, we have
extensively tested this update against :ref:`recommended hardware <Specific Hardware Recommendations>`.
