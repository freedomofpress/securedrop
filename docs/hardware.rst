...
Workstations
~~~~~~~~~~~~
.. note:: SecureDrop depends on the Tails operating system for its bootable USB drives.
	The upcoming version of Tails, Tails 3.0, will no longer support 32-bit computers.
...
.. note:: The upcoming version of Tails, Tails 3.0, will no longer support 32-bit computers.
	Please see the note in the :ref:`Workstations <Workstations>` section for more details.
